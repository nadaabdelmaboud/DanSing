...
namespace IBM.Watsson.Examples
{
    public class ExampleStreaming : MonoBehaviour
    {
        ...
        public static AudioSource audioss;
        private SpeechToTextService _service;
        public static string allspeech2 = "";
        ...
        private IEnumerator RecordingHandler()
        {
            ...
            while (_recordingRoutine != 0 && _recording != null)
            {
                  ...
                  || (!bFirstBlock && writePos < midPoint))
                {
                    ...
                    audios.outputAudioMixerGroup = microphonemixer;
                    audios.clip = record.Clip;
                    audioss.clip = audios.clip;
                    audios.Play();
            ...
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        string dat = text.Split(' ')[0];
                        if (tmp != dat) allspeech2 += dat + " ";
        ...
        private void FixedUpdate()
        {
          ...
          //  Debug.Log("All speech is : "+allspeech);
            float[] spectrumData = audios.GetSpectrumData(visualizerSimples, 0, FFTWindow.Rectangular);
